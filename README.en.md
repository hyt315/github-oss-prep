...
[Input: Any local project / directory to open-source]
                         │
              [Step 0: 10 Universal Archetype Positioning]
              Identify: AI Skill / MCP Server / Model / CLI / Extension / IaC / ...
                         │
              ...
              Generate YAML Issue Forms / PR Templates / SECURITY.md / CI / Dependabot
                         │
              [Step 3: Progressive Archetype Facade Rendering]
              Progressively loads only the dedicated archetype template & dynamic badges
                         │
              [Step 4: All-Ecosystem Distribution Setup]
              Configure uvx / bunx / HuggingFace / ChromeStore / gh skill / Checksums
                         │
